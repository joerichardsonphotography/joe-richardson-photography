    ...
    >
      <body className="flex min-h-full flex-col bg-[#FAFAF8] font-body text-[#111111]">
        ...
        <nav className="fixed right-4 top-6 z-40 flex flex-col items-end gap-1 md:right-6 md:top-8">
          <Link
            href="/about"
            className="-m-3 p-3 font-display font-black text-[6vw] uppercase leading-none tracking-[-0.02em] text-[#111111] transition-opacity duration-150 hover:opacity-50 md:text-[1.4vw]"
          >
            About
          </Link>
          <Link
